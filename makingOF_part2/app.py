...
# add verification of chatTemplateCheck.py
# to ad a try/except for the tokenizer load - not all models are correctly converted to IR format
...
try:
    ...
    print("Tokenizer not correctly converted for this Model. Impossible to proceed.")
try:
